...
ansible-playbook -e "subnetname=testvpc2 subnetaddress=10.164.4.48/28 sharedvpcname=aisarch-common-host sharedvpcprojectid=aisarch-common-host networkuser=user:kristians.voronics@if.lv serviceprojectid=aisarch-security-hub-prod region=europe-north1 zone=europe-north1-a" -i ansible_hosts gce-instances.yml